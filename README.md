...
* DLY: Changes the delay of the operator.
...
* RTO: Changes the ratio of operator A.
...
* To save the preset click on save preset.
* To load one of your presets click on load preset after having specified its path

#### Sound Features
IMMAGINE MODULO FEATURES

From the graph above it's possible to see in real time what are the features of the sound obtained from the FM synthesis. In this way is possible to understand how to tune the parameters in order to achieve a specific sound quality.
